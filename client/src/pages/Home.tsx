...
import { Volume2, Trophy, ArrowRight, Sparkles, BookOpen, Languages } from "lucide-react";
      ...
      <header className="w-full max-w-4xl flex flex-col md:flex-row justify-between items-center gap-6 mb-8 bg-white/80 backdrop-blur-md p-4 rounded-3xl shadow-sm border border-white relative z-10">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Link href="/transliteration">
            <Button variant="outline" className="rounded-full gap-2 border-sky-200 text-sky-700 hover:bg-sky-50 flex">
